  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "bg-fade-in": {
          "0%": {
            "background-color": "bg-[conic-gradient(from_90deg_at_50%_50%,#4BE7AE_0%,#043E29_50%,#4BE7AE_100%)]/0",
          },
          "100%": {
            "background-color": "bg-[conic-gradient(from_90deg_at_50%_50%,#4BE7AE_0%,#043E29_50%,#4BE7AE_100%)]/100",
          },
        },
        "domain-link-in": {
          "0%": {
