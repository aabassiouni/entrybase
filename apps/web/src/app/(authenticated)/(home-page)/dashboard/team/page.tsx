          ...
          <CardContent className="">
            <div className="flex h-96 items-center justify-center">
              <div className="flex h-1/2 w-1/2 flex-col items-center justify-center gap-4 rounded-md border border-primary bg-neutral-900">
                <p className="text-center font-medium text-lg">Team members are only available on the Pro plan.</p>
                <p className="text-neutral-400">Create a new workspace to invite members to your team</p>
