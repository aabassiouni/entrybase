  ...
  return (
    <Form {...form}>
      <div className="flex basis-1/2 flex-col items-center gap-4">
        <div>
          <p className="text-center font-bold text-2xl">Website Details</p>
          <p className="text-center text-neutral-500 text-sm">Add your website name and links here</p>
        </div>
              ...
              <FormField
                ...
                render={({ field: { onChange, value, ...field } }) => (
                  <FormItem>
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <div
                              ...
                              className={cn(
                                "mx-auto flex h-12 w-12 items-center justify-center rounded-xl border-2 border-zinc-900",
                              )}
                            >
                              {!color && <Ban />}
                            </div>
                    ...
                    <FormDescription />
                    <FormMessage className="mx-auto flex w-28 flex-grow-0 text-wrap text-center" />
                  </FormItem>
                )}
              />
            </div>
