				...
				<div className="flex flex-col gap-10">
					...
					<div className="self-center">
						<Link href={"https://github.com/aabassiouni/waitlister"}>
							...
							<button className="animate-background-shine inline-flex h-12 items-center justify-center gap-2 rounded-md border border-primary bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
								<GitHubLogoIcon className="h-6 w-6 text-white" />
								<p className="font-semibold text-white">Star On GitHub</p>
							</button>
						</Link>
