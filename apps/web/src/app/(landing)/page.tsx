  ...
  return (
    <div className="sm:flex-1">
      ...
      <div className="relative px-4 pb-10">
        <div className="-z-10 absolute inset-0 h-full w-full animate-[appear_1s_linear] items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#020705_40%,#4BE7AE_100%)]" />
      ...
      <div className="h- relative flex flex-col items-center sm:py-16">
        <div className="-z-10 absolute inset-0 h-full w-full animate-[appear_1s_linear] items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_90%,#020705_40%,#4BE7AE_100%)]" />
      </div>
      ...
      <div className="mx-auto max-w-screen-lg space-y-8 px-4 py-16">
        <div className="space-y-2">
          ...
          <p className="text-balance text-center text-lg text-neutral-400 sm:text-xl">
            Entrybase lets you take control of your waitlist and choose who you want to invite and when. Launch on your
            terms.
          </p>
        </div>
        ...
        <div className="grid max-w-screen-lg flex-1 grid-cols-1 grid-rows-4 gap-4 sm:grid-cols-5 sm:grid-rows-5">
          ...
          <GradientBorderCard flexdir="flex-col" className="sm:col-span-3 sm:row-span-2">
            <div>
              ...
              <GradientBorderCardDescription>
                Craft tailored invitations that resonate with your audience. With customizable templates, your invites
          ...
          <GradientBorderCard flexdir="flex-col" className="sm:col-span-2 sm:row-span-2">
            <div>
              ...
              <GradientBorderCardDescription>
                Seamlessly integrate your waitlist into your website with custom domains. Provide a consistent,
                professional look across your digital presence.
              </GradientBorderCardDescription>
            </div>
